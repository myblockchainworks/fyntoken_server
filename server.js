...
app.post('/myTokenBalance', function(req, res) {
  ...
  fynTokenContract.balanceOf.call(address, function(err, result) {
      //console.log(result);
      if (!err) {
...
app.post('/transferToken', function(req, res) {
  ...
  // step 1
  var solidityFunction = new SolidityFunction('', _.find(fynTokenContractABI, { name: 'transfer' }), '');
...
app.get('/getArgEncoded', function(req, res) {
  ...
  var parameterValues = ["FundYourselfNow Token", "FYN",  0, 12500000, "0x895324D4d8E9Bf08db6C78d828B8498291e7AB4c", 100];
